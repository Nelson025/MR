setwd("F:\\先兆子痫_糖尿病\\T2D\\02.TwoSampleMR")      #设置工作目录

#### 1.加载结局数据 ----
load('finndataR10_T2D_outcome.rdata')
...
exposureName="preeclampsia"                         #图形中展示暴露数据的名称
outcomeName="Type 2 diabetes"       #图形中展示结局数据的名称
